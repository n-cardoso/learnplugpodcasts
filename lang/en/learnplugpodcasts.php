...
$string['analytics_learner'] = 'Learner';
$string['analytics_learnerhotspots'] = 'Learner hotspots';
$string['analytics_learnerhotspots_sub'] = 'Strongest listened zone for each learner and episode.';
$string['analytics_likes'] = 'Likes';
$string['analytics_listenedtime'] = 'Listened time';
$string['analytics_listeners'] = 'Listeners';
$string['analytics_status'] = 'Status';
$string['analytics_topzones'] = 'Most listened zones';
$string['analytics_topzones_sub'] = 'Top repeated or revisited parts of each episode, based on learner listening ranges.';
$string['analytics_totallistened'] = 'Total listened';
$string['analytics_zone'] = 'Zone';
...
$string['exportactivelearners'] = 'Active learners';
$string['exportactivity'] = 'Overall activity CSV';
$string['exportall'] = 'All analytics (normalized CSV)';
$string['exportanalyticscsv'] = 'Export analytics (CSV)';
$string['exportcompletions'] = 'Completed learners';
$string['exportdatasetdescription'] = 'Choose a focused CSV report, or download all analytics in one normalized table.';
$string['exportepisodes'] = 'Per-episode analytics CSV';
$string['exporthotspots'] = 'Listening hotspots CSV';
$string['exportlearners'] = 'Per-learner progress CSV';
$string['exportliked'] = 'Liked';
$string['exportmetric'] = 'Metric';
$string['exportpagetitle'] = 'Export listening analytics';
$string['exportreport'] = 'Report';
$string['exportscope'] = 'Scope';
$string['exportscopeepisode'] = 'Episode aggregate';
$string['exportscopelearner'] = 'Learner';
$string['exportsectionactivity'] = 'Overall activity analytics';
$string['exportsectionepisodes'] = 'Per-episode analytics';
$string['exportsectionhotspots'] = 'Listening hotspots';
$string['exportsectionlearners'] = 'Per-learner progress';
$string['exporttotalepisodes'] = 'Total episodes';
$string['exportunit'] = 'Unit';
$string['exportunitcount'] = 'count';
$string['exportunitdatetime'] = 'datetime';
$string['exportunitpercent'] = 'percent';
$string['exportunitseconds'] = 'seconds';
$string['exportvalue'] = 'Value';
$string['exportzoneend'] = 'Zone end (s)';
$string['exportzonestart'] = 'Zone start (s)';
...
$string['privacy:metadata:learnplugpodcasts_zone'] = 'Stores listening heatmap buckets for learner playback zones.';
$string['privacy:metadata:learnplugpodcasts_zone:bucketstart'] = 'The start time in seconds for the listened bucket.';
$string['privacy:metadata:learnplugpodcasts_zone:episodeid'] = 'The episode ID.';
$string['privacy:metadata:learnplugpodcasts_zone:listenedsecs'] = 'How many seconds were listened within this time bucket.';
$string['privacy:metadata:learnplugpodcasts_zone:podcastid'] = 'The podcast series ID.';
$string['privacy:metadata:learnplugpodcasts_zone:timecreated'] = 'When the heatmap bucket record was created.';
$string['privacy:metadata:learnplugpodcasts_zone:timemodified'] = 'When the heatmap bucket record was last modified.';
$string['privacy:metadata:learnplugpodcasts_zone:userid'] = 'The learner whose listening generated this bucket.';
...
$string['resetprogressall'] = 'Reset all learner progress';
$string['resetprogressconfirmall'] = 'Delete all learner listening progress and heatmap analytics for this podcast?';
$string['resetprogressconfirmuser'] = 'Delete listening progress and heatmap analytics for {$a} in this podcast?';
$string['resetprogressdoneall'] = 'All learner listening progress was reset for this podcast.';
$string['resetprogressdoneuser'] = 'Listening progress was reset for {$a}.';
$string['resetprogressuser'] = 'Reset progress';
